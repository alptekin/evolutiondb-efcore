...
public class EvolutionDbSqlGenerationHelper : RelationalSqlGenerationHelper
{
    public EvolutionDbSqlGenerationHelper(RelationalSqlGenerationHelperDependencies dependencies)
        : base(dependencies)
    {
        //...
    }
